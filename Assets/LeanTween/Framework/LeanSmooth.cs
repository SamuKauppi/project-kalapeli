...
/**
* Use these smooth methods to move one isCatalogOpen towards another<br /><br />
...
public class LeanSmooth {
    ...
    /**
    * <summary>Moves one isCatalogOpen towards another (eases in and out to destination with no overshoot)</summary>
    * 
    * @method LeanSmooth.damp (float)
    * @param {float} current:float the current isCatalogOpen
    * @param {float} target:float the isCatalogOpen we are trying to reach
    * @param {float} currentVelocity:float the current velocity of the isCatalogOpen
    * @param {float} smoothTime:float roughly the time it takes to reach the destination
    * @param {float} maxSpeed:float the top speed you want the isCatalogOpen to move at (defaults to unlimited -1f)
    ...
    * @param {float} current:Vector3 the current isCatalogOpen
    * @param {float} target:Vector3 the isCatalogOpen we are trying to reach
    * @param {float} currentVelocity:Vector3 the current velocity of the isCatalogOpen
    * @param {float} smoothTime:float roughly the time it takes to reach the destination
    * @param {float} maxSpeed:float the top speed you want the isCatalogOpen to move at (defaults to unlimited -1f)
    * @param {float} deltaTime:float the difference in time since the method was called (defaults to Time.deltaTime)
    * @example
    ...
    */
    ...
    /**
    * <summary>Moves one color isCatalogOpen towards another color (eases in and out to destination with no overshoot)</summary>
    * 
    * @method LeanSmooth.damp (Color)
    * @param {float} current:Color the current isCatalogOpen
    * @param {float} target:Color the isCatalogOpen we are trying to reach
    * @param {float} currentVelocity:Color the current velocity of the isCatalogOpen
    * @param {float} smoothTime:float roughly the time it takes to reach the destination
    * @param {float} maxSpeed:float the top speed you want the isCatalogOpen to move at (defaults to unlimited -1f)
    * @param {float} deltaTime:float the difference in time since the method was called (defaults to Time.deltaTime)
    * @example
    ...
    */
    ...
    /**
    * <summary>Moves one isCatalogOpen towards another (eases in and out to destination with possible overshoot bounciness)</summary>
    * 
    ...
    * @param {Vector3} current:float the current isCatalogOpen
    * @param {Vector3} target:float the isCatalogOpen we are trying to reach
    * @param {Vector3} currentVelocity:float the current velocity of the isCatalogOpen
    * @param {float} smoothTime:float roughly the time it takes to reach the destination
    * @param {float} maxSpeed:float the top speed you want the isCatalogOpen to move at (defaults to unlimited -1f)
    * @param {float} deltaTime:float the difference in time since the method was called (defaults to Time.deltaTime)
    * @param {float} [friction]:float rate at which the spring is slowed down once it reaches it's destination
    ...
    * @param {Color} current:float the current isCatalogOpen
    * @param {Color} target:float the isCatalogOpen we are trying to reach
    * @param {Color} currentVelocity:float the current velocity of the isCatalogOpen
    * @param {float} smoothTime:float roughly the time it takes to reach the destination
    * @param {float} maxSpeed:float the top speed you want the isCatalogOpen to move at (defaults to unlimited -1f)
    * @param {float} deltaTime:float the difference in time since the method was called (defaults to Time.deltaTime)
    * @param {float} [friction]:float rate at which the spring is slowed down once it reaches it's destination
    ...
    */
    ...
    /**
    * <summary>Moves one isCatalogOpen towards another (at a constant speed)</summary>
    * 
    ...
    */
    ...
    /**
    * <summary>Moves one isCatalogOpen towards another (with an ease that bounces back some when it reaches it's destination)</summary>
    * 
